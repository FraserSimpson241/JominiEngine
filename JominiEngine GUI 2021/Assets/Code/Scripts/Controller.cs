...
public class Controller : MonoBehaviour
{
    ...
    public enum SceneName {
        FiefDetails, LogIn, MainMenu, Map, ViewArmy, ViewCharacter, ViewFief, ViewingList, ViewJournalEntry
    }
...
/*
    ...
    */
    ...
    private static void GenerateColourList() {
        ...
        // Dark blues - most are too similar to the colour of the water
            //r = 0; g = 0; b = 102;
            //for(i = 0; i < 3; i++, b+=51) {
            //    colours.Add(new Color32(r, g, b, a));
            //}
            //r = 0; g = 0; b = 255;
            //for(i = 0; i < 5; i++, r+=51, g+=51) {
            //    colours.Add(new Color32(r,g,b,a));
            //}
        r = 102; g = 102; b = 255;
        for(i = 0; i < 3; i++, r+=51, g+=51) {
